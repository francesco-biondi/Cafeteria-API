...
public interface ExpenseMapper {
    ...
    Expense toEntity(ExpenseRequestDTO expenseRequestDTO, @Context Supplier supplier);
    void updateExpenseFromDTO(ExpenseUpdateDTO expenseUpdateDTO, @Context Supplier supplier, @MappingTarget Expense expense);
